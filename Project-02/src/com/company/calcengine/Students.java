...
public class Students {
    ...
    public void getData(){
        ...
        //Input the Lab Exercise points earned
        Scanner inputLabPoints = new Scanner(System.in);
        System.out.print("Enter the Total Points for Lab Exercises (Max Points: 750): ");
        labPoints = inputLabPoints.nextInt();

        //Input the Project points earned
        ...
        //Input the Final Exam points earned
